...
def main():
    ...
    <div style="text-align:center">
        <a href="https://github.com/sanregi/Portfolio">
            <img src="https://github.com/sanregi/MOD-19/blob/main/ebac_logo-data_science.png?raw=true" alt="ebac_logo-data_science" width=100%>
        </a>
    </div> 
    ...
    **Aluno:** [Régis Sandes](https://www.linkedin.com/in/regis-sandes/)<br>
    **Data:** 25 de março de 2024.
    ...
    st.sidebar.markdown(
        body='<img src="https://github.com/sanregi/MOD-19/blob/main/6d642553dfa669bdb1a53fde683b686351c929858bad68e461937802.jpg?raw=true" width=100%>',
        unsafe_allow_html=True,
    )
    ...
    if data_file_1 is not None:
        ...
        bank_raw = load_data(
            # file_data="https://raw.githubusercontent.com/sanregi/MOD-19/main/banco%20de%20dados/bank-additional-full.csv",
